...
export interface UserPreferences {
  /** Custom panel colors per source */
  panelColors?: Record<string, Color>
  /** Sources hidden by the user in each column */
  hiddenSources?: Record<FixedColumnID, SourceID[]>
  /** Panel order/layout for each column */
  panelOrder?: Record<FixedColumnID, SourceID[]>
  /** Last active column */
  lastActiveColumn?: FixedColumnID
